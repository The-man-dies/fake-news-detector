...
export default function InfoCard({ id, title, authorAvatar, description, image, reliability, status, time }: NewsItem) {
    return (
        <div key={id} className=" w-full flex flex-col ">
            <div className="bg-secondary rounded-[20px] w-full h-[194px] lg:h-[350px] overflow-hidden lg:rounded-none">
            ...
            <div className="flex flex-row justify-between relative">
                <div className="h-[4px] w-[70%] bg-card-foreground flex justify-between overflow-hidden">
                    <div className={`h-full  bg-primary`} style={{ width: `${reliability}%` }}></div>
                </div>
            ...
            <h1 className="text-[16px] -mt-2 text-card-foreground/80 my-3">{description}</h1>

            <div className="rounded-full w-[32px] h-[32px] lg:w-11 lg:h-11 overflow-hidden ">
